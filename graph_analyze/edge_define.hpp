...
namespace Hypervision
{
    ...
    public:
        long_edge(const decltype(p_flow) p_flow,
                  ...
                  const decltype(p_time_distribution) p_time_distribution) : p_flow(p_flow), p_length_distribution(p_length_distribution),
    ...
    public:
        short_edge(const decltype(p_flow) p_flow, const decltype(agg_indicator) agg_indicator) : p_flow(p_flow), agg_indicator(agg_indicator) {}
