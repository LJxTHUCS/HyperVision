...
namespace Hypervision
{
    ...
    public:
        ...
        basic_dataset(const decltype(p_parse_result) &p_parse_result,
                      const double_t train_ratio = 0.25, const double_t attack_time_after = 0.0) : p_parse_result(p_parse_result), train_ratio(train_ratio), attack_time_after(attack_time_after) {}
        ...
        {
            p_attacker_src4 = make_shared<decltype(p_attacker_src4)::element_type>(attacker_src4.cbegin(), attacker_src4.cend());
            p_attacker_src6 = make_shared<decltype(p_attacker_src6)::element_type>(attacker_src6.cbegin(), attacker_src6.cend());
            p_attacker_dst4 = make_shared<decltype(p_attacker_dst4)::element_type>(attacker_dst4.cbegin(), attacker_dst4.cend());
            p_attacker_dst6 = make_shared<decltype(p_attacker_dst6)::element_type>(attacker_dst6.cbegin(), attacker_dst6.cend());
            p_attacker_srcdst4 = make_shared<decltype(p_attacker_srcdst4)::element_type>(attacker_srcdst4.cbegin(), attacker_srcdst4.cend());
            p_attacker_srcdst6 = make_shared<decltype(p_attacker_srcdst6)::element_type>(attacker_srcdst6.cbegin(), attacker_srcdst6.cend());
        }
